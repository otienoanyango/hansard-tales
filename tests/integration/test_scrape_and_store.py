...
class TestScrapeAndStore:
    ...
    def test_scrape_hansard_and_store(self, mock_get, temp_storage):
        """
        ...
        **Validates: Requirements 4.1, 4.6, 5.1**
        ...
        # Create scraper
        config = ScraperConfig(download_dir=temp_storage / "pdfs")
        ...
        with patch.object(
            scraper,
            "get_document_urls",
            return_value=["https://parliament.go.ke/test/hansard_20240115.pdf"],
        ):
            # Scrape documents
    ...
    @patch("hansard_tales.scrapers.base.requests.Session.get")
    def test_scrape_votes_and_store(self, mock_get, temp_storage):
        """
        ...
        **Validates: Requirements 4.2, 4.6, 5.1**
        ...
        with patch.object(
            scraper,
            "get_document_urls",
            return_value=["https://parliament.go.ke/test/votes_20240115.pdf"],
        ):
            # Scrape documents
            documents = scraper.scrape(Chamber.NATIONAL_ASSEMBLY, skip_existing=False)
    ...
    def test_duplicate_detection_across_scrapes(self, temp_storage):
        """
...
class TestEndToEndWorkflow:
    ...
    def test_scrape_process_store_workflow(self, temp_storage):
        """
        ...
        **Validates: Requirements 4.1, 5.1, 5.7, 2.6**
        ...
        pdf_dir = temp_storage / "pdfs"
        pdf_dir.mkdir(exist_ok=True)

        vector_dir = temp_storage / "vector_db"
