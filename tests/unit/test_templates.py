...
class TestBaseTemplate:
    ...
    def test_base_template_has_required_blocks(self, jinja_env):
        ...
        template_path = Path(__file__).parent.parent.parent / 'templates' / 'layouts' / 'base.html'
...
class TestPageTemplate:
    ...
    def test_test_page_extends_base(self, jinja_env):
        ...
        template_path = Path(__file__).parent.parent.parent / 'templates' / 'pages' / 'test.html'
        source = template_path.read_text()
...
class TestStaticAssets:
    ...
    def test_main_css_exists(self):
        ...
        css_file = Path(__file__).parent.parent.parent / 'static' / 'css' / 'main.css'
        assert css_file.exists()
        assert css_file.is_file()
    
    def test_main_js_exists(self):
        """Test that main JavaScript file exists."""
        js_file = Path(__file__).parent.parent.parent / 'static' / 'js' / 'main.js'
