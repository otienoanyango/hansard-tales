...
class DocumentStorageService:
    ...
    def store_document(self, processed_pdf: ProcessedPDF, document: Document) -> str:
        """
    ...
    def is_duplicate(self, source_hash: str) -> bool:
        ...
        existing = self.db.query(DocumentORM).filter(DocumentORM.source_hash == source_hash).first()
    ...
    def get_document(self, document_id: str) -> Document | None:
        ...
        """
        from hansard_tales.database.models import DocumentORM
        from hansard_tales.models.base import Chamber, DocumentType, SourceReference

        doc_orm = self.db.query(DocumentORM).filter(DocumentORM.id == document_id).first()
